                                ...
                                <tbody>
                                    ...
                                    foreach ($rumah as $l) : ?>
                                        <tr>
                                            ...
                                            <td><?= $l['unit']; ?></td>
                                            <td>
                                                <a href="<?= base_url('pimpinan/detailrumah/') . $l['id']; ?>" type="button" class="btn btn-info btn-sm waves-effect btn-label waves-light"><i class="bx bx-detail label-icon "></i> Detail</button>
