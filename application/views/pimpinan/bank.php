                                ...
                                <tbody>
                                    ...
                                    foreach ($bank as $b) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($b['is_active'] == 1) : ?>
                                                    <a href="<?= base_url('pimpinan/nonaktif/') . $b['id']; ?>" type="button" class="btn btn-danger btn-sm waves-effect btn-label waves-light"><i class="bx bx-show label-icon "></i> Non Aktif</a>
                                                <?php else : ?>
                                                    <a href="<?= base_url('pimpinan/aktif/') . $b['id']; ?>" type="button" class="btn btn-success btn-sm waves-effect btn-label waves-light"><i class="bx bx-hide label-icon"></i> Aktif</a>
                                                <?php endif; ?>

                                                <a href="<?= base_url('pimpinan/edit_bank/') . $b['id']; ?>" type="button" class="btn btn-warning btn-sm waves-effect btn-label waves-light"><i class="bx bx-edit label-icon "></i> Edit</a>
                                                <a type="button" href="<?= base_url('pimpinan/delete_bank/') . $b['id']; ?>" onclick="return confirm('Data akan dihapus?');" class="btn btn-danger btn-sm waves-effect btn-label waves-light"><i class="bx bx-trash-alt label-icon "></i> Delete</a>
