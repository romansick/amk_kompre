                                ...
                                <tbody>
                                    ...
                                    foreach ($getuser as $u) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($u['is_active'] == 1) : ?>
                                                    <a href="<?= base_url('pimpinan/aktif_user/') . $u['id']; ?>" type="button" class="btn btn-danger btn-sm waves-effect btn-label waves-light"><i class="bx bx-hide label-icon "></i> Non Aktif</a>
                                                <?php else : ?>
                                                    <a href="<?= base_url('pimpinan/non_aktif_user/') . $u['id']; ?>" type="button" class="btn btn-success btn-sm waves-effect btn-label waves-light"><i class="bx bx-show-alt label-icon "></i> Aktif</a>
                                                <?php endif; ?>
