                                ...
                                <tbody>
                                    ...
                                    foreach ($bank as $b) : ?>
                                        <tr>
                                            ...
                                            <!-- <td>
                                                <?php if ($b['is_active'] == 1) : ?>
                                                    <a href="<?= base_url('administrator/nonaktif/') . $b['id']; ?>" type="button" class="btn btn-success btn-sm waves-effect btn-label waves-light"><i class="bx bx-show label-icon "></i> Aktif</a>
                                                <?php else : ?>
                                                    <a href="<?= base_url('administrator/aktif/') . $b['id']; ?>" type="button" class="btn btn-danger btn-sm waves-effect btn-label waves-light"><i class="bx bx-hide label-icon"></i> Non Aktif</a>
                                                <?php endif; ?>

                                                <a href="<?= base_url('administrator/edit_bank/') . $b['id']; ?>" type="button" class="btn btn-warning btn-sm waves-effect btn-label waves-light"><i class="bx bx-edit label-icon "></i> Edit</a>
