                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('administrator/savebank'); ?>" method="post">
                                ...
                                <div class="form-group d-flex justify-content-end">
                                    ...
                                    <a href="<?= base_url('administrator/bank'); ?>" type="button" class="btn btn-warning btn-sm waves-effect ml-3 btn-label waves-light" data-dismiss="modal"><i class="bx bx-error label-icon "></i> Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
