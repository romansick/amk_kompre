                                    ...
                                    foreach ($getuser as $u) : ?>
                                        <tr>
                                            ...
                                            <!-- <td>
                                                ...
                                                <a href="<?= base_url('administrasi/edit_user/') . $u['id']; ?>" type="button" class="btn btn-warning btn-sm waves-effect btn-label waves-light"><i class="bx bx-edit label-icon "></i> Edit</a>
