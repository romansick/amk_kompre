                                    ...
                                    foreach ($rumah as $l) : ?>
                                        <tr>
                                            ...
                                            <td class="text-body font-weight-bold">
                                                <?php $rupiah = "Rp " . number_format($l['harga'], 2, ',', '.'); ?>
                                                <?= $rupiah; ?>
                                            </td>
                                            <td><?= $l['lokasi']; ?></td>
                                            <td><?= $l['blok']; ?></td>
                                            <td>
                                                <a href="<?= base_url('administrasi/edit_rumah/') . $l['id']; ?>" type="button" class="btn btn-warning btn-sm waves-effect btn-label waves-light"><i class="bx bx-edit label-icon "></i> Edit</a>
